...
var budgetController = (function() {
    ...
    return {
        ...
        deleteItem: function(type, id) {
            ...
            // data.allItems[type][id] ne vaka zostho moze da ne e po red id-to vo nizata
            // var ids = [1, 2, 4, 6, 8]
...
var contoller = (function(budgetCtrl, UICtrl){
    ...
    var ctrlDeleteItem = function(event){
        ...
        if (itemID) {
            ...
            // 1. Delete items from the data structure
